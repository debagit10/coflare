          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="/docs"
                  onClick={(e) => handleComingSoon(e, "Documentation")}
                  className="text-sm text-sidebar-foreground/70 hover:text-white transition-colors"
                >
                  Documentation
                </a>
              ...
              <li>
                <a
                  href="/api"
                  onClick={(e) => handleComingSoon(e, "API Access")}
                  className="text-sm text-sidebar-foreground/70 hover:text-white transition-colors"
                >
                  API Access
                </a>
              ...
              <li>
                <a
                  href="/data"
                  onClick={(e) => handleComingSoon(e, "Data Downloads")}
                  className="text-sm text-sidebar-foreground/70 hover:text-white transition-colors"
                >
                  Data Downloads
                </a>
                ...
                <Dialog open={researchOpen} onOpenChange={setResearchOpen}>
                  ...
                  <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Partner with us for academic or institutional research
                        using Co-flare data.
                      </DialogDescription>
                    </DialogHeader>
                    <form
                      onSubmit={(e) => submitForm(e, "research")}
                      className="space-y-4"
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="res-topic"
                          required
                          placeholder="e.g. Flood patterns in coastal areas"
                        />
                      </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
                ...
                <Dialog open={partnerOpen} onOpenChange={setPartnerOpen}>
                  ...
                  <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Join forces with us to build resilient communities and
                        scale environmental monitoring.
                      </DialogDescription>
                    </DialogHeader>
                    <form
                      onSubmit={(e) => submitForm(e, "partnership")}
                      className="space-y-4"
                    >
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="part-type"
                          required
                          placeholder="e.g. Technology, Funding, Operations"
                        />
                      </div>
                      <Button type="submit" className="w-full">
                        Request Partnership
              ...
              <li>
                <a
                  href="/press"
                  onClick={(e) => handleComingSoon(e, "Press Kit")}
                  className="text-sm text-sidebar-foreground/70 hover:text-white transition-colors"
                >
                  Press
                </a>
